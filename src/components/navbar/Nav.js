    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-info">
            <div className="container-fluid">
                <a className="navbar-brand fs-1 fw-bold" href="!#">Note Scribbler</a>
                    ...
                    <ul className="navbar-nav mb-2 mb-lg-0">
                        <li className="nav-item dropdown my-3">
                            ...
                            <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a className="dropdown-item" href="!#" onClick={() => sorter('latest')}>Latest first</a></li>
                                <li><a className="dropdown-item" href="!#" onClick={() => sorter('oldest')}>Oldest first</a></li>
                                <li><a className="dropdown-item" href="!#" onClick={() => sorter('high')}>Priority high</a></li>
                                <li><a className="dropdown-item" href="!#" onClick={() => sorter('normal')}>Priority normal</a></li>
                            </ul>
                        </li>

                        <li className='nav-item mx-2'>
                            <button className='nav-link btn btn-sm btn-warning text-light px-2 my-3' onClick={() => setShowModal(true)}><Plus /> Add new</button>
                        </li>
                        <li className='nav-item mx-2'>
